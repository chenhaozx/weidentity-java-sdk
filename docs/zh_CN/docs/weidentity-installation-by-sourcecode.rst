...
.. list-table::
   ...
   * - app
     - 打包好的SDK jar包。
   * - conf
     - SDK运行时的一些配置，Java应用集成weid-java-sdk的时候，需要将此目录下的所有文件放到您自己Java应用的classpath下。
   * - lib
     - 依赖的jar包。
